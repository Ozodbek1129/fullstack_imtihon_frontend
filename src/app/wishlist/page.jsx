  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="text-center">
        <h2 className="text-5xl bg-orange-500 text-white py-10">
          Siz yoqtirgan mahsulotlar
        </h2>
      </div>
      {data.length === 0 ? (
        <h2 className="text-orange-500 text-center mt-20">Mahsulot hali mavjud emas</h2>
      ) : (
